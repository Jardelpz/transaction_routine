...
type AccountRepositoryMock struct {
	...
	GetByIdFunc    func(ctx context.Context, accountId int64) (*domain.Account, error)
...
func (m *AccountRepositoryMock) GetById(ctx context.Context, accountId int64) (*domain.Account, error) {
	return m.GetByIdFunc(ctx, accountId)
}

func (m *AccountRepositoryMock) ExistsById(ctx context.Context, accountId int64) (bool, error) {
